...
async def main(args):
    ...
    try:
        ...
        # =================================================
        # STARTUP NEWS / CATALYST BOOTSTRAP
        # =================================================

        # Best-effort: startup at ~10:15 immediately loads announcements released
        # after the prior session / before today. A news outage never blocks the bot.
        try:
            await service.startup_bootstrap()
        except Exception as exc:
            print(f"[startup] news bootstrap degraded: {exc!r}")
        ...
        print("[main] provider order: SAHMK -> Tasilab")
        print("[main] configured SAHMK keys: 1")
